...
assert(investorAppDataRouteV0340.includes('liveGain = liveInvested > 0 ? Number(liveSummary.currentValue || 0) - liveInvested : positionGain') && investorAppDataRouteV0340.includes('gainLoss: Number(gainLoss.toFixed(2))'), "v0.34.3 authenticated Investor App API uses the same portfolio-level current-minus-invested gain/loss definition");
