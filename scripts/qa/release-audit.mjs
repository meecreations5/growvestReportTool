...
assert(portfolioImportCentre.includes('.xls,.xlsx,.csv,.pdf') && portfolioImportCentre.includes('/\\.(xls|xlsx|csv|pdf)$/i') && portfolioImportCentre.includes("supported digital PDF") && portfolioImportCentre.includes("Angel One DP") && portfolioImportCentre.includes("DP Movements"), "Unified Import file picker and selection gate both accept supported digital broker PDFs and preview Angel One DP movement separately");
