...
export default function CommentaryLibraryPicker({ reportMonth, reportYear, onApply }) {
  ...
  return (
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-[70] bg-slate-950/50 p-0 sm:p-4" role="dialog" aria-modal="true" aria-label="Select approved market commentary">
          <div className="mx-auto flex h-full w-full max-w-6xl flex-col overflow-hidden bg-white sm:h-[calc(100vh-2rem)] sm:rounded-2xl sm:shadow-2xl">
            <header className="flex items-start justify-between gap-4 border-b border-slate-200 px-5 py-4 sm:px-6">
              <div>
                ...
                <h2 className="mt-1 font-heading text-2xl font-bold text-slate-950">Market Commentary Library</h2>
