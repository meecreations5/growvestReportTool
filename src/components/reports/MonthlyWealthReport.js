...
function SectionCard({ children, className = "", id }) {
...
export default function MonthlyWealthReport({ report, history = [], viewer = "staff" }) {
  ...
  return (
    <div className="monthly-wealth-report relative grid gap-6 overflow-hidden">
      ...
      <section id="report-overview" className="scroll-mt-32 relative z-[1] overflow-hidden rounded-2xl bg-[#111827] p-5 text-white shadow-sm sm:p-7 lg:p-8">
        ...
        <div className="relative z-10 flex items-start justify-between gap-4">
          <span className="inline-flex items-center rounded-full border border-white/10 bg-white/[0.05] px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.18em] text-slate-300 sm:text-xs">
        ...
        <div className="relative z-10 mt-7 grid gap-7 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-end xl:grid-cols-[minmax(0,1fr)_320px] xl:gap-9">
          ...
          <aside className="rounded-2xl border border-white/15 bg-white/[0.065] p-4 sm:p-5">
      ...
      <SectionCard id="report-performance" className="scroll-mt-32 p-5 sm:p-6">
      ...
      <SectionCard id="portfolio-composition" className="p-5 sm:p-6">
      ...
      <section id="report-goals" className="scroll-mt-32">
      ...
      <SectionCard id="report-allocation" className="scroll-mt-32 p-5 sm:p-6">
      ...
      <SectionCard id="report-holdings" className="scroll-mt-32 overflow-hidden">
      ...
      <section id="report-commentary" className="scroll-mt-32 rounded-2xl bg-[#152238] p-5 text-white sm:p-7 md:p-8">
      ...
      <SectionCard id="report-actions" className="scroll-mt-32 p-5 sm:p-6">
      ...
      <SectionCard id="report-review" className="scroll-mt-32 p-5 sm:p-6">
      ...
      <SectionCard id="report-disclaimer" className="scroll-mt-32 p-5 sm:p-6">
