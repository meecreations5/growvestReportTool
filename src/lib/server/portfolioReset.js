...
export async function loadPortfolioResetContext(investor) {
  ...
  const [
    ...
    investorRows("brokerAccounts", investorId),
    investorRows("brokerAccountSnapshots", investorId),
    investorRows("brokerDpTransactions", investorId),
    ...
    investorRows("manualPortfolioAccounts", investorId),
    investorRows("manualPortfolioAccountSnapshots", investorId),
    investorRows("manualPortfolioCashLedger", investorId),
    investorRows("manualPortfolioIncome", investorId),
    investorRows("manualPortfolioCorporateActions", investorId),
    investorRows("manualPortfolioCharges", investorId),
    investorRows("manualPortfolioGoalAllocations", investorId),
    investorRows("manualPortfolioReconciliations", investorId),
    investorRows("manualPortfolioNotes", investorId),
...
export function portfolioContextHasResettableState(context, { excludeImportBatchIds = [] } = {}) {
  ...
  const groups = [
    ...
    context.brokerAccounts,
    context.brokerAccountSnapshots,
    context.brokerDpTransactions,
    context.snapshots,
    ...
    context.sipCycles,
    context.manualPortfolioAccounts,
    context.manualPortfolioAccountSnapshots,
    context.manualPortfolioCashLedger,
    context.manualPortfolioIncome,
    context.manualPortfolioCorporateActions,
    context.manualPortfolioCharges,
    context.manualPortfolioGoalAllocations,
    context.manualPortfolioReconciliations,
    context.manualPortfolioNotes,
...
export function portfolioResetPreview(context) {
  ...
  return {
    ...
    counts: {
      ...
      brokerAccounts: context.brokerAccounts.length,
      brokerAccountSnapshots: context.brokerAccountSnapshots.length,
      brokerDpTransactions: context.brokerDpTransactions.length,
      sipSchedules: context.sipSchedules.length,
      sipCycles: context.sipCycles.length,
      manualAccounts: context.manualPortfolioAccounts.length,
      manualAccountSnapshots: context.manualPortfolioAccountSnapshots.length,
      manualCashEntries: context.manualPortfolioCashLedger.length,
      manualIncome: context.manualPortfolioIncome.length,
      manualCorporateActions: context.manualPortfolioCorporateActions.length,
      manualCharges: context.manualPortfolioCharges.length,
      manualGoalAllocations: context.manualPortfolioGoalAllocations.length,
      manualReconciliations: context.manualPortfolioReconciliations.length,
      manualNotes: context.manualPortfolioNotes.length,
    ...
    state: {
      ...
      trading: context.trades.length || context.tradingSummaries.length || context.brokerAccounts.length || context.brokerAccountSnapshots.length || context.brokerDpTransactions.length ? "available" : "no_trading_data"
    },
